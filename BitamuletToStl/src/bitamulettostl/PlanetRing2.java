...
public class PlanetRing2 extends Union {
    ...
    private static List<Abstract3dModel> getModels(double lat, double lng, long date, int type) {
        ...
        switch (type) {
            ...
            case 2:
                modelcase = new Translate(new StlFile("bracelet_3_2.stl"), new Coords3d(0, 52, 0)).rotate(Angles3d.zOnly(90));
                //max orbit = 16, sun is 3.5 + (2*0.85) spare, so 10.8 / (8-1) = 1.5429
                ORBIT_RADIUS = 1.5429;
                CASE_SIZE = 32;
                break;
            case 3:
                modelcase = new Translate(new StlFile("bracelet_eclipse.stl"), new Coords3d(0, 200, 0));
            ...
            default:
                ...
                ORBIT_RADIUS = 1.4714;
                CASE_SIZE = 31;
                modelcase = new Translate(new StlFile("case (repaired).stl"), new Coords3d(-120.8, -54.5, 1.5));
                break;
        }
